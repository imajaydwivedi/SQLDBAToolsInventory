...
class Instance(models.Model):
    ...
    serverid = models.IntegerField(db_column='ServerID')  # Field name made lowercase.
...
class Backupschedule(models.Model):
    ...
    instanceid = models.IntegerField(db_column='InstanceId')  # Field name made lowercase.
    databaseid = models.IntegerField(db_column='DatabaseId')  # Field name made lowercase.
